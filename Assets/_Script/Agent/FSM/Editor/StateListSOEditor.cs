...
namespace _Script.Agent.FSM.Editor
{
    ...
    public class StateListSOEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            root.Q<Button>("GenerateButton").clicked += HandleGenerateEnumButtonClick;

            return root;
        }

        private void HandleGenerateEnumButtonClick()
        {
            ...
            string code = string.Format(CodeFormat.EnumFormat, "Agents.FSM", listData.enumName, enumString);
